...
/**
 * Tool for listing 4HSE equipment
 */
class EquipmentListTool
{
    /**
     * List 4HSE equipment with optional filters.
     * Requires OAuth2 authentication.
     *
     * @param string|null $filterOfficeEquipmentId Filter by office equipment ID
     * @param string|null $filterOfficeId Filter by office ID
     * @param string|null $filterProjectId Filter by project ID
     * @param string|null $filterEquipmentId Filter by equipment ID
     * @param string|null $filterCode Filter by equipment code
     * @param string|null $filterName Filter by equipment name
     * @param string|null $filterDescription Filter by equipment description
     ...
     * @param string|null $filterCategory Filter by equipment category
     ...
     * @return array List of equipment with pagination
     */
    #[
        McpTool(
    ...
    public function listEquipment(
        #[
            Schema(
                type: "string",
                description: "Filter by office equipment ID (UUID format)",
            ),
        ]
        ?string $filterOfficeEquipmentId = null,
        ...
        #[
            Schema(
                type: "string",
                description: "Filter by equipment ID (UUID format)",
            ),
        ]
        ...
        #[
            Schema(type: "string", description: "Filter by equipment category"),
        ]
        ...
        try {
            ...
            $filter = [];
            if ($filterOfficeEquipmentId !== null) {
                $filter["office_equipment_id"] = $filterOfficeEquipmentId;
            }
            ...
            if ($filterEquipmentId !== null) {
                $filter["equipment_id"] = $filterEquipmentId;
            }
            if ($filterCode !== null) {
            ...
            $result = $client->index("equipment", $params);
