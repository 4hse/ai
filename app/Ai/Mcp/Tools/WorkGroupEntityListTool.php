...
class WorkGroupEntityListTool
{
    ...
    public function listWorkGroupEntities(
        ...
        #[Schema(
            ...
            enum: ['work_group_code', '-work_group_code', 'work_group_name', '-work_group_name', 'work_group_type', '-work_group_type', 'entity_name', '-entity_name', 'entity_code', '-entity_code', 'entity_type', '-entity_type']
        )]
        ?string $sort = null,
