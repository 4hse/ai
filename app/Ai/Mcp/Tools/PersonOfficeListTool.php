...
class PersonOfficeListTool
{
    ...
    #[McpTool(
        ...
        description: 'Retrieves a paginated list of 4HSE person-office associations with optional filters. Requires OAuth2 authentication.'
    )]
    public function listPersonOffices(
        #[Schema(
            type: 'string',
            description: 'Filter by person-office ID'
        )]
        ...
        #[Schema(
            type: 'string',
            description: 'Filter by person tax code'
        )]
        ...
        #[Schema(
            ...
            enum: ['person_code', '-person_code', 'person_first_name', '-person_first_name', 'person_last_name', '-person_last_name', 'person_birth_date', '-person_birth_date', 'person_tax_code', '-person_tax_code']
        )]
        ?string $sort = null,
