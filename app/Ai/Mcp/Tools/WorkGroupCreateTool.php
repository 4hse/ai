...
class WorkGroupCreateTool
{
     ...
     * @param string $workGroupType Work group type
    ...
    #[McpTool(
        ...
        description: 'Creates a new work group/team in 4HSE. Requires OAuth2 authentication.'
    )]
    public function createWorkGroup(
        #[Schema(
            type: 'string',
            description: 'Work group name (required)'
        )]
        string $name,
        ...
        #[Schema(
            type: 'string',
            description: 'Work group type (required)'
        )]
        string $workGroupType,

        #[Schema(
            type: 'string',
            description: 'Work group code'
        )]
        ?string $code = null,
