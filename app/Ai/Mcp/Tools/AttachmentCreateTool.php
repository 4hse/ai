    ...
    public function createAttachment(
        ...
        try {
            ...
            if ($fileContent !== null && $fileContent !== '') {
                ...
                if ($decodedContent === false) {
                    return [
                        ...
                        'message' => 'The provided file content is not valid base64 encoded data.',
                    ];
                }
                $formData['file'] = $decodedContent;
            }
            ...
            return match ($errorCode) {
                ...
                409 => [
                    'error' => 'Conflict',
                    'message' => 'Destination path already exists. Use replace=1 to overwrite existing files.',
                    'code' => $errorCode,
                ],
                413 => [
                ...
                500 => [
                    'error' => 'Server error',
                    'message' => 'Failed to create attachment for unknown reason.',
                    'code' => $errorCode,
                ],
                default => [
