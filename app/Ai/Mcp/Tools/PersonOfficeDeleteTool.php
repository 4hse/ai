...
class PersonOfficeDeleteTool
{
    ...
    #[McpTool(
        ...
        description: 'Deletes a person-office association in 4HSE. Requires OAuth2 authentication.'
    )]
        ...
        try {
            ...
            if ($e->getCode() === 400) {
                return [
                    ...
                    'code' => $e->getCode(),
                    'hint' => 'The person-office has related entities. Use force=true to delete all related entities.',
                ];
            }
