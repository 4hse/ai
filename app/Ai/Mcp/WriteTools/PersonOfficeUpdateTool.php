 ...
 * This updates the assignment of a person to a specific office within a project.
...
class PersonOfficeUpdateTool
{
    ...
    #[
        McpTool(
            ...
            description: "Updates an existing person-office association in 4HSE, modifying the assignment of a person to a specific office within a project. Note: Persons can also exist at project level without office assignment. Requires OAuth2 authentication.",
        ),
    ]
    public function updatePersonOffice(
        ...
        #[
            Schema(type: "string", description: "Person ID in UUID format"),
        ]
