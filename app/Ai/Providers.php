...
class Providers
{
    ...
    public static function getProvider(string $modelId): AIProviderInterface
    {
        return match ($modelId) {
            'bedrock.claude-3-sonnet-20240229-v1:0' => self::getBedrockProvider('anthropic.claude-3-sonnet-20240229-v1:0'),
            'gemini-2.5-flash' => self::getGeminiProvider($modelId),
            default => throw new Exception("Model not found: $modelId"),
        };
    }

    protected static function getGeminiProvider(string $modelId): AIProviderInterface
    {
        return new Gemini(
    ...
    protected static function getBedrockProvider(string $modelId): AIProviderInterface
    {
